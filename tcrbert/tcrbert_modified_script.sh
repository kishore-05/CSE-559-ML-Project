...
pip install pandas==1.4.3 numpy==1.21.6 scikit-learn==1.1.2 imbalanced-learn==0.9.1 transformers==4.23.1 datasets==2.4.0 psutil --quiet
...
python tcrbert_improved_multi-head-attention.py